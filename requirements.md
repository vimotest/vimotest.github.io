...
**WIDGET**: The ViMoTest DSL shall provide several common GUI widgets like buttons, check-boxes, tables etc.

**CMD**: The ViMoTest DSL shall provide several common GUI commands.
...
| ID | Requirement | User Story | Reason | Importance | Notes | Status |
|----|-------------|------------|--------|------------|-------|--------|
| **WIDGET-001** | Support Buttons | As a view developer, I need to support buttons | Buttons are needed in mostly any UI | ![MUST HAVE](https://github.com/vimotest/vimotest.github.io/raw/main/images//req_importance_musthave.png) | Properties: Visibility, Enabled, Text |Done |
| **WIDGET-002** | Support Check-boxes | As a view developer, I need to support check-boxes |  | ![MUST HAVE](https://github.com/vimotest/vimotest.github.io/raw/main/images//req_importance_musthave.png) | Properties: Visibility, Enabled, Text, Checked-State (tri-state?) |Done |
| **WIDGET-003** | Support Radio Buttons | As a view developer, I need to support radio buttons |  | ![MUST HAVE](https://github.com/vimotest/vimotest.github.io/raw/main/images//req_importance_musthave.png) | Properties: Visibility, Enabled, Selected |Done |
| **WIDGET-004** | Support Labels | As a view developer, I need to support labels |  | ![MUST HAVE](https://github.com/vimotest/vimotest.github.io/raw/main/images//req_importance_musthave.png) | Properties: Visibility, Enabled, Text |Done |
| **WIDGET-005** | Support Image Views | As a view developer, I need to support icons/images |  | ![MUST HAVE](https://github.com/vimotest/vimotest.github.io/raw/main/images//req_importance_musthave.png) | Properties: Visibility, Image |Done |
| **WIDGET-006** | Support Combo-boxes | As a view developer, I need to support comboboxes |  | ![MUST HAVE](https://github.com/vimotest/vimotest.github.io/raw/main/images//req_importance_musthave.png) | Properties: Visibility, Selected Text, Text Values |Done |
| **WIDGET-010** | Support List Views | As a view developer, I need to support list views |  | ![MUST HAVE](https://github.com/vimotest/vimotest.github.io/raw/main/images//req_importance_musthave.png) | Properties: Visibility, Enabled, List Items |Done |
| **WIDGET-011** | Support Table Views | As a view developer, I need to support table views |  | ![MUST HAVE](https://github.com/vimotest/vimotest.github.io/raw/main/images//req_importance_musthave.png) | Properties: Visibility, Enabled, Table Items |Done |
...
| ID | Requirement | User Story | Reason | Importance | Notes | Status |
|----|-------------|------------|--------|------------|-------|--------|
| **CONTEXT-001** | Allow reuse of context | As a test developer, I want to reuse context definitions of other test scenarios | Reduce redundancy | ![MUST HAVE](https://github.com/vimotest/vimotest.github.io/raw/main/images//req_importance_musthave.png) |  |Done |
...
| **ASSERT-020** | Support verifying Messaging | As a test developer, I want to verify that the ViewModel fired messages on a Message/Event Bus (Pub/Sub) | View Navigation is sometimes integrated via Messaging (Pub/Sub) | ![SHOULD HAVE](https://github.com/vimotest/vimotest.github.io/raw/main/images//req_importance_shouldhave.png) |  |To Do |

### 6 Technical DSL Features
