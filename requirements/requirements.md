...
| **UICOMP-051** | Color Support | As a view developer, I want to be able to have support for coloring of text-based components |  | ![SHOULD HAVE](https://github.com/vimotest/vimotest.github.io/raw/main/images//req_importance_shouldhave.png) | specific foreground, background, seletion colors |
